...
MK_RPKM <- MK_RPKM[match(MKgenelist$Symbol,rownames(MK_RPKM)),]
...
unnasig_enz_order <- c("Kat6a","Kat6b","Mcm3ap","Kmt2b","Hdac2","Smyd2","Kdm8","Naa60","Ash1l","Kmt2a","Kmt5b","Kdm3b","Setd2") 

unassigned_enz_counts <- unassigned_enz_counts[match(unnasig_enz_order,rownames(unassigned_enz_counts)),]

pheatmap(unassigned_enz_counts[,1:18], fontsize = 10, scale = "row", cluster_cols = FALSE, cluster_rows = FALSE)
