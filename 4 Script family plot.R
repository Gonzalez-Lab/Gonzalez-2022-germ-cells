...
H3K4me_families <- Enz_MK_RPKM %>% 
  filter(H3K4me %in% me_index) %>% mutate(Family_Mark=paste(Family,H3K4me)) %>% 
...
H3K4me_families$Enzyme <- c(rep("Eraser",3),rep("Writer",6))

#H3K4me writers N
n=6
H3K4me_writers <- as.data.frame(cbind(Cell=c(rep("SGThy1",n),rep("SGKit",n),
                                          rep("SCyte",n),rep("STid",n),rep("Sperm",n)),
                                   Family=rep(H3K4me_families[4:9,1],5),
                                   RPKM= c(H3K4me_families[4:9,2],
                                           H3K4me_families[4:9,3],
                                           H3K4me_families[4:9,4],
                                           H3K4me_families[4:9,5],
                                           H3K4me_families[4:9,6])))
...
H3K9me_families <- Enz_MK_RPKM %>% 
  filter(H3K9me %in% me_index) %>% mutate(Family_Mark=paste(Family,H3K9me)) %>% 
  group_by(Family_Mark) %>% summarize(sumSGThy1=sum(SGThy1),
                                      sumSGKit=sum(SGKit),
                                      sumSCyte=sum(SCyte),
                                      sumSTid=sum(STid),
...
H3K9me_families$Enzyme <- c(rep("Eraser",5),rep("Writer",5))

#H3K9me writers N
n=5
H3K9me_writers <- as.data.frame(cbind(Cell=c(rep("SGThy1",n),rep("SGKit",n),
                                              rep("SCyte",n),rep("STid",n),rep("Sperm",n)),
                                       Family=rep(H3K9me_families[6:10,1],5),
                                       RPKM= c(H3K9me_families[6:10,2],
                                               H3K9me_families[6:10,3],
                                               H3K9me_families[6:10,4],
                                               H3K9me_families[6:10,5],
                                               H3K9me_families[6:10,6])))
...
H3K9me_erasers <- as.data.frame(cbind(Cell=c(rep("SGThy1",n),rep("SGKit",n),
                                              rep("SCyte",n),rep("STid",n),rep("Sperm",n)),
                                       Family=rep(H3K9me_families[1:5,1],5),
                                       RPKM= c(H3K9me_families[1:5,2],
                                               H3K9me_families[1:5,3],
                                               H3K9me_families[1:5,4],
                                               H3K9me_families[1:5,5],
                                               H3K9me_families[1:5,6])))
...
H4K20me_families <- Enz_MK_RPKM %>% 
  filter(H4K20me %in% me_index) %>% mutate(Family_Mark=paste(Family,H4K20me)) %>% 
  group_by(Family_Mark) %>% summarize(sumSGThy1=sum(SGThy1),
                                      sumSGKit=sum(SGKit),
                                      sumSCyte=sum(SCyte),
                                      sumSTid=sum(STid),
...
H4K20me_families$Enzyme <- c(rep("Eraser",3),rep("Writer",6))

#H4K20me writers N
n=6
H4K20me_writers <- as.data.frame(cbind(Cell=c(rep("SGThy1",n),rep("SGKit",n),
                                              rep("SCyte",n),rep("STid",n),rep("Sperm",n)),
                                       Family=rep(H4K20me_families[4:9,1],5),
                                       RPKM= c(H4K20me_families[4:9,2],
                                               H4K20me_families[4:9,3],
                                               H4K20me_families[4:9,4],
                                               H4K20me_families[4:9,5],
                                               H4K20me_families[4:9,6])))
...
H4K20me_erasers <- as.data.frame(cbind(Cell=c(rep("SGThy1",n),rep("SGKit",n),
                                              rep("SCyte",n),rep("STid",n),rep("Sperm",n)),
                                       Family=rep(H4K20me_families[1:3,1],5),
                                       RPKM= c(H4K20me_families[1:3,2],
                                               H4K20me_families[1:3,3],
                                               H4K20me_families[1:3,4],
                                               H4K20me_families[1:3,5],
                                               H4K20me_families[1:3,6])))
